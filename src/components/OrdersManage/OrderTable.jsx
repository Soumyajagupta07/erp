...
import 'react-calendar/dist/Calendar.css'; // Importing the default styles for react-calendar
...
function OrderTable() {
    ...
    const handleDateChange = (date) => {
        setSelectedDate(date); // Update selectedDate state when the date changes
    };
